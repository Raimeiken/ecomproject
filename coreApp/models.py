...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=9999999, decimal_places=2, default="0.99")
    old_price = models.DecimalField(max_digits=9999999, decimal_places=2, default="1.99")

    # specifications = models.TextField(null=True, blank=True)
    specifications = RichTextUploadingField(null=True, blank=True)
    type = models.CharField(max_length=100, default="Catalyst", null=True, blank=True)
    ...
    sku = ShortUUIDField(unique = True, length=4, max_length=15, prefix="sku", alphabet="abcdefgh12345")
...
######################################################### Cart, Order, Order Times, Address
#######################################################
###################################################
######################################
...
class CartOrderItems(models.Model):
    ...
    price = models.DecimalField(max_digits=9999999, decimal_places=2, default="0.99")
    total = models.DecimalField(max_digits=9999999, decimal_places=2, default="0.99")
