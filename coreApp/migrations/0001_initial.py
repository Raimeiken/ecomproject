# Generated by Django 4.2.7 on 2024-01-24 09:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='0.99', max_digits=9999999)),
                ('paid_status', models.BooleanField(default=False)),
                ('order_date', models.DateTimeField(auto_now_add=True)),
                ('product_status', models.CharField(choices=[('process', 'processing'), ('shipped', 'Shipping'), ('delivered', 'Delivering')], default='processing', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='product.jpg', upload_to=coreApp.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is the product.', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='0.99', max_digits=9999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='1.99', max_digits=9999999)),
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=4, max_length=15, prefix='sku', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='vendor.jpg', upload_to=coreApp.models.user_directory_path)),
        ...
        migrations.AddField(
            model_name='product',
            name='tags',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='coreApp.tags'),
        ),
        migrations.AddField(
            model_name='product',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='0.99', max_digits=9999999)),
                ('total', models.DecimalField(decimal_places=2, default='0.99', max_digits=9999999)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='coreApp.cartorder')),
            ],
            options={
